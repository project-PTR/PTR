...
function create_lecture_detail_all(){
    ...
    allLecture.forEach((lecture, index)=>{
        ...
        user_item_cash.textContent = "강사 이름: " + lecture.teacher.user.userName + "(아이디 " + lecture.teacher.user.userId + ")"
        ...
        .then((response)=>{
            ...
            user_item_total.textContent = "영상 판매금액: " + (lecture.price * 200 * response.data) + "원"
        })
        .catch((error)=>{
            console.log("에러: ", error)
        })
        ...
        user_item_feed.textContent = "단백질바: " + lecture.price + "개(" + (lecture.price * 200) + "원)"
...
function create_lecture_detail_teacher(){
    const user_list_user_flex = document.querySelector(".lecture_list_today_flex");
...
function showLectureDetail(lecture){
    ...
    const box1_div2 = document.createElement("div");
    box1_div2.textContent = "강사 이름: " + lecture.teacher.user.userName + "(아이디 " + lecture.teacher.user.userId + ")"

    const box1_div3 = document.createElement("div");
    box1_div3.textContent = "단백질바: " + lecture.price + "개(" + (lecture.price * 200) + "원)"
    ...
    .then((response)=>{
        ...
        lectureCategory.forEach((lectureCategory, index)=>{
            if(index==0){
                categoryString = categoryString + lectureCategory.category.categoryName
            }else{
                categoryString = categoryString + ", " + lectureCategory.category.categoryName
            }
        })
    ...
    .then((response)=>{
        ...
        box2_div3.textContent = "영상 판매금액: " + (lecture.price * 200 * response.data) + "원"
    })
    .catch((error)=>{
        console.log("에러: ", error)
    })
...
document.querySelector(".content_menu_manager_lecture").addEventListener("click", ()=>{
    document.querySelector(".content_menu_manager_lecture").classList.add("content_menu_bold")
    document.querySelector(".content_menu_manager_home").classList.remove("content_menu_bold")
    document.querySelector(".content_menu_manager_user").classList.remove("content_menu_bold")
...
document.querySelector(".box_tatal_lectures").addEventListener("click", ()=>{
    ...
    document.querySelector(".manager_lecture_allBtn").id = "manager_user_btn_flex_hiden"
...
document.querySelector(".box_today_upload").addEventListener("click", ()=>{
    ...
    document.querySelector(".manager_lecture_todayBtn").id = "manager_user_btn_flex_hiden"
...
// 강의관리의 버튼
document.querySelector(".manager_lecture_allBtn").addEventListener("click", ()=>{
    document.querySelector(".lecture_list_all").classList.remove("hiden")
    document.querySelector(".lecture_list_today").classList.add("hiden")
...
document.querySelector(".manager_lecture_todayBtn").addEventListener("click", ()=>{
    document.querySelector(".lecture_list_today").classList.remove("hiden")
    document.querySelector(".lecture_list_all").classList.add("hiden")
...
document.querySelector(".manager_lecture_teacherBtn").addEventListener("click", ()=>{
    document.querySelector(".lecture_list_today").classList.add("hiden")
    document.querySelector(".lecture_list_all").classList.add("hiden")

    document.querySelector(".manager_lecture_teacherBtn").id = "manager_user_btn_flex_hiden"
    document.querySelector(".manager_lecture_allBtn").id = ""
    document.querySelector(".manager_lecture_todayBtn").id = ""
